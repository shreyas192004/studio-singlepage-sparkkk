...
TASK:
Extract a SINGLE, CLEAR SUBJECT from the image and convert it into a PRINT-READY T-SHIRT GRAPHIC.

SUBJECT SELECTION (VERY IMPORTANT):
- Identify the PRIMARY SUBJECT only (character, creature, symbol, or main object)
- KEEP the primary subject
...
- All buildings
- All landscapes
- All props not attached to the subject
- Any secondary objects
...
- No floor, no ground, no horizon

THIS IS NOT:
- NOT a poster
- NOT a painting
- NOT an illustration scene
- NOT concept art
...
TEXT RULES:
${text ? `Include this text cleanly and boldly with the subject: "${text}"` : "NO text or lettering"}

FINAL CHECK (MANDATORY):
✔ Only ONE subject visible  
✔ No background pixels  
✔ Ready to print on a T-shirt  
`;
